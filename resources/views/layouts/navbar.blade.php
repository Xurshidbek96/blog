<div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
    <div class="navbar-nav font-weight-bold mx-auto py-0">
        <a href="/" class="nav-item nav-link active">@lang('navbar.home')</a>
        <!-- <a href="about.html" class="nav-item nav-link">About</a> -->
        <a href="/groups" class="nav-item nav-link">@lang('navbar.groups')</a>
        <a href="/teachers" class="nav-item nav-link">@lang('navbar.teachers')</a>
